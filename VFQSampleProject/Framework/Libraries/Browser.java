...
public class Browser extends SampleDriver {
	...
	public static class WebLink {
		...
		public static String gettextL(String objname) throws Exception {
			String objtype = "WebLink";
			Common.ConditionalWait(objname, objtype);
			String[] objprop = Utlities.FindObject(objname, objtype);
			return Method.getvalL(objprop);
		}
		...
		* Last Modified Date : 07-March-2017
		...
		public static void clickL(String objname, int rownum, int columnnum) throws Exception {
			try {
				...
				Common.ConditionalWait(objname, "WebTable");
				String[] objprop = Utlities.FindObject(objname, "WebTable");
				if (currKW.get().equals("RealTimeBalance_Screen")||currKW.get().equals("Modify")||currKW.get().equals("Suspension"))
					cellXpath = objprop[0] + "//tr[" + rownum + "]//td[" + (columnnum + 2) + "]";
				else				
					cellXpath = objprop[0] + "//tr[" + rownum + "]//td[" + (columnnum + 1) + "]";				
				//cDriver.get().findElement(By.xpath(cellXpath)).click();
				...
				//Result.fUpdateLog(Batchs.get() + " :: Failed at Obj: " + objname + " to clickL");
				//throw new Exception();
				//cDriver.get().findElement(By.xpath("(//a[@name='Account Name'])[1]")).click();
				
			}
		}
			public static void clickM(String objname, int rownum, int columnnum) throws Exception {
			try {
				Common.ConditionalWait(objname, "WebTable");
				String[] objprop = Utlities.FindObject(objname, "WebTable");
				String cellXpath = objprop[0] + "//tr[" + rownum + "]//td[" + (columnnum + 2) + "]";
				cDriver.get().findElement(By.xpath(cellXpath)).click();
				String cellXpath1 = objprop[0] + "//tr[" + rownum + "]//td[" + columnnum + "]//a";
				cDriver.get().findElement(By.xpath(cellXpath1)).click();
				Result.fUpdateLog(Batchs.get() + " :: Action Click on Obj: " + objname);
		...
		* Last Modified Date : 13-January-2017
		...
		public static void SetData(String objname, int rownum, int columnnum, String obj, String Val) throws Exception {
			try {
				...
				public static void SetDataB(String objname, int rownum, int columnnum, String obj, String Val) throws Exception {
			try {
				Common.ConditionalWait(objname, "WebTable");
				String[] objprop = Utlities.FindObject(objname, "WebTable");
				String cellXpath = objprop[0] + "//tr[" + rownum + "]//td[" + columnnum + "]";
				...
				Thread.sleep(200);
				for(int i=0;i<=20;i++) {
					cDriver.get().findElement(By.xpath(cellXpath1)).sendKeys(Keys.BACK_SPACE);
					Thread.sleep(10);
				}
				Thread.sleep(100);
				String vis = "false";
		...
		/*------------------------------------------------------------------------------------------------------
		* Function Name: SetCellVal
		* Use : Sets the Specified value to the cell after refresh the page
		* Designed By: sisira
		* Last Modified Date : 03-July-2019
		--------------------------------------------------------------------------------------------------------*/		
		public static void SetDataCustom(String objname, int rownum, int columnnum, String obj, String Val) throws Exception {
			try {
				Common.ConditionalWait(objname, "WebTable");
				String[] objprop = Utlities.FindObject(objname, "WebTable");
				String cellXpath = objprop[0] + "//tr[" + rownum + "]//td[" + columnnum + "]";
				...
				cDriver.get().findElement(By.xpath(cellXpath1)).clear();
				Thread.sleep(500);
				int columnnum1=columnnum-1;
				String cellXpath2 = objprop[0] + "//tr[" + rownum + "]//td[" + columnnum1 + "]"; 
